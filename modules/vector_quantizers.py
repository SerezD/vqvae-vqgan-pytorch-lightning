...
class VectorQuantizer(nn.Module):
    ...
    def __init__(self, num_embeddings, embedding_dim):
        ...
        self.commitment_cost = 0.25  # scaling factor for e_loss
        ...
        self.decay = 0.95
        self.epsilon = 1e-5  # smoothing parameters for ema_weights
    ...
    def forward(self, x):
        ...
        # sum of the used indexes
        used_indices = torch.sum(encodings, dim=0)
        ...
        return e_loss, rearrange(quantized, 'b h w c -> b c h w').contiguous(), used_indices
